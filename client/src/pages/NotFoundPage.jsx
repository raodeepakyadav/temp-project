...
export default function NotFoundPage() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center py-20 px-4 text-center">
      <div className="w-16 h-16 rounded-xl bg-white border border-slate-200 text-[#1e3a5f] flex items-center justify-center mb-4 shadow-sm">
        <Compass className="w-8 h-8" />
      </div>
      <span className="text-4xl sm:text-6xl font-bold text-slate-900 tracking-tight">
        404
      </span>
